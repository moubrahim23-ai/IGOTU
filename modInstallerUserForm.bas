...
Private Sub ConstruireInterface(ByVal formulaire As Object)
    ...
    With formulaire
        .Caption = "Saisie des realisations"
        .Width = 930
        .Height = 590
    ...
    controle.BorderStyle = BORDURE_SIMPLE
    controle.TextAlign = ALIGNEMENT_GAUCHE
    controle.WordWrap = True
    controle.SpecialEffect = EFFET_PLAT
End Sub
...
Private Function AjouterZoneTexte(ByVal conteneur As Object, ByVal nom As String, _
    ...
    With controle
        ...
        .WordWrap = multiligne
        .EnterKeyBehavior = multiligne
        .BackColor = IIf(verrouille, RGB(226, 232, 240), RGB(255, 255, 255))
        .ForeColor = RGB(31, 41, 55)
        .BorderStyle = BORDURE_SIMPLE
        .SpecialEffect = EFFET_PLAT
        .Font.Name = "Segoe UI"
        .Font.Size = 9
    End With
